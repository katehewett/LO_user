...
print('Time to get initial fields = %0.2f sec' % (time()-tt1))
sys.stdout.flush()
...
for ii in range(nlay):
    ...
    sys.stdout.flush()
print('Time to calculate ARAG for all layers = %0.2f sec' % (time()-tt1))
...
print('Time to get corrosive_dz = %0.2f sec' % (time()-tt1))
sys.stdout.flush()
