"""
Plots subanoxic volume time series.
...
indir = indir0 + item + '/'
fn = indir + 'subanoxic_volume_daily.nc'
...
ax1.set_xticklabels([])
ax1.text(.03,.9, 'SubAnoxic Volume [km3]', transform=ax1.transAxes)
ax2.text(.03,.9, 'Fractional SubAnoxic Volume', transform=ax2.transAxes)
...
fig.savefig(out_dir + '/subanoxia_1_NEW.png')
