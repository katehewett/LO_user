...
def get_sta_dict(job_name):
    ...
    elif job_name == 'OCNMS_moorings_historical':
        sta_dict = {
    ...
    elif job_name == 'OCNMS_moorings_current': # current mooring deployments exclude depths >42m (see OCNMS_moorings_historical)   
        sta_dict = {
            'MB015': (-124.6768	48.3254),	
            'MB042': (-124.7354	48.324),
            'CA015': (-124.7568	48.1663),
