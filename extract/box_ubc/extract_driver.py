"""
This is code to extract the domain for Salish Sea Cast's BC's 
As requested by Susan Allen and Doug Latournell at UBC

It is a modified version of post_main.py 
https://github.com/parkermac/LO/blob/main/post/ubc1/post_main.py

But we modified to extract their domain from the long hindcast and then *not* concatonate

Right now it's taking in ubc0 
MODIFY 
Testing on mac:
run extract_driver.py -gtx cas7_t0_x4b -ro 1 -0 2017.12.12 -1 2017.12.13 -job ubc1 -test True

run extract_box_nocat.py -gtx cas7_t0_x4b -ro 1 -0 2017.12.12 -1 2017.12.13 -job ubc1 -test True
