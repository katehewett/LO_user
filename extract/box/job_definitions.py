...
def get_box(job, Lon, Lat):
    ...
    if job == 'sequim0':
        ...
        aa = [-124.7, -124.1, 44.65, 44.65]  
        vn_list = 'h,pm,pn,mask_rho,mask_u,mask_v,zeta,u,v,w,ubar,vbar,salt,temp,rho,NO3,oxygen,sustr,svstr,bustr,bvstr,AKs,AKv,Uwind,Vwind'
    elif job == 'tester':
        aa = [-125, -124, 47, 49]  
