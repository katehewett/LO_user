...
def get_box(job, Lon, Lat):
    ...
    if job == 'sequim0':
        ...
        vn_list = 'h,pm,pn,mask_rho,zeta,u,v,ubar,vbar,salt,temp,rho,NO3,NH4,phytoplankton,zooplankton,SdetritusN,LdetritusN,SdetritusC,LdetritusC,oxygen,alkalinity,TIC,sustr,svstr,bustr,bvstr,AKs,AKv,Uwind,Vwind'
    elif job == 'tester':
        aa = [-125, -124, 47, 49]  
